...
public class SizeComputationExpressionTest extends AbstractSiriusSwtBotGefTestCase {
    ...
    private static final int HEIGHT_AUTO_SIZED = 41;

    private static final int WIDTH_AFTER_RENAME = 263;

    private static final String NEW_ECLASS_NAME = "EClass01234567890123456789"; //$NON-NLS-1$
    ...
    public void testAutoSizeComputationExpression() {
        ...
        assertEquals(HEIGHT_AUTO_SIZED, sizeAfterRename.height);
        assertEquals(WIDTH_AFTER_RENAME, sizeAfterRename.width);

        moveNodeTwiceAndCheckSize(eClassEP, HEIGHT_AUTO_SIZED, WIDTH_AFTER_RENAME);
    }
