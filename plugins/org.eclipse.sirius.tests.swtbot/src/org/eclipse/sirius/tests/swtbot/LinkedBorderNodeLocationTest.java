...
public class LinkedBorderNodeLocationTest extends AbstractSiriusSwtBotGefTestCase {
    ...
    private static void checkBorderNodePosition(Rectangle borderedNodeBounds, Rectangle borderNodeBounds, int expectedSide) {
        ...
        case PositionConstants.NORTH:
            assertEquals(borderedNodeBounds.getTop().y, borderNodeBounds.getBottom().y - 8, 2);
            break;
        case PositionConstants.EAST:
            assertEquals(borderedNodeBounds.getRight().x, borderNodeBounds.getLeft().x + 10, 2);
            break;
        case PositionConstants.SOUTH:
            assertEquals(borderedNodeBounds.getBottom().y, borderNodeBounds.getTop().y + 10, 2);
            break;
        case PositionConstants.WEST:
            assertEquals(borderedNodeBounds.getLeft().x, borderNodeBounds.getRight().x - 8, 2);
            break;
        }
